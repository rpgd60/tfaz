...
module "static_website" {
  ...
  # source = "git@github.com:rpgd60/tf-azure-webstatic.git"                     ## github over https
  source = "git::https://github.com/rpgd60/tf-azure-webstatic.git?ref=1.0.0"  ## Using generic git method
